...
def get_data_loaders(dataset_name, batch_size, data_augmentation=False, split_seed=42):
    """
    ...
    if dataset_name == 'cifar10':
        ...
        train_set, val_set = torch.utils.data.random_split(full_train_dataset, [train_size, val_size], generator=gen)
